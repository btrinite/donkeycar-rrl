...
def get_model_by_type(model_type: str, cfg: 'Config') -> Union['KerasPilot', 'FastAiPilot']:
    ...
    if used_model_type == "linear":
        kl = KerasLinear(interpreter=interpreter, input_shape=input_shape, have_odom=cfg.HAVE_ODOM, have_lane_loc=cfg.ROBOCARS_LANE_MODEL, num_lane_cat=cfg.ROBOCARS_NUM_LANE_CAT, have_acc_loc=cfg.ROBOCARS_ACC_MODEL, num_acc_cat=cfg.ROBOCARS_NUM_ACC_CAT)
