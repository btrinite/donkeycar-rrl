...
DATA_PATH = os.path.join(CAR_PATH, 'data/data_steering')
OBSTACLE_DATA_PATH = os.path.join(CAR_PATH, 'data/data_obstacle')
FULL_IMAGE_DATA_PATH = os.path.join(CAR_PATH, 'data/data_fullimg')
...
ROBOCARS_LANE_STEERING_ADJUST_STEPS=[0,0.2,0.4]
...
OBSTACLE_MIN_SCORE = 0.2
OBSTACLE_SHOW_BOUNDING_BOX = True
OBSTACLE_DETECTOR_ROI_TOP = 0.2
OBSTACLE_DETECTOR_ROI_BOTTOM = 0.8
OBSTACLE_DETECTOR_ROI_LEFT = 0.45
OBSTACLE_DETECTOR_ROI_RIGHT = 0.55
